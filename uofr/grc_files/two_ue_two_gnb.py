...
class two_ue_two_gnb(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "two_ue_two_gnb")
        ...
        self.zeromq_req_source_0_1 = zeromq.req_source(gr.sizeof_gr_complex, 1, 'tcp://localhost:2010', 100, False, (-1), False)
        self.zeromq_req_source_0_0_0 = zeromq.req_source(gr.sizeof_gr_complex, 1, 'tcp://localhost:3010', 100, False, (-1), False)
        self.zeromq_req_source_0_0 = zeromq.req_source(gr.sizeof_gr_complex, 1, 'tcp://localhost:3000', 100, False, (-1), False)
        self.zeromq_req_source_0 = zeromq.req_source(gr.sizeof_gr_complex, 1, 'tcp://localhost:2000', 100, False, (-1), False)
        self.zeromq_rep_sink_0_1 = zeromq.rep_sink(gr.sizeof_gr_complex, 1, 'tcp://*:2009', 100, False, (-1), True)
        self.zeromq_rep_sink_0_0_0 = zeromq.rep_sink(gr.sizeof_gr_complex, 1, 'tcp://*:3009', 100, False, (-1), True)
        self.zeromq_rep_sink_0_0 = zeromq.rep_sink(gr.sizeof_gr_complex, 1, 'tcp://*:3008', 100, False, (-1), True)
        self.zeromq_rep_sink_0 = zeromq.rep_sink(gr.sizeof_gr_complex, 1, 'tcp://*:2008', 100, False, (-1), True)
        self._cell_gain1_range = qtgui.Range(0, 1, 0.1, 0.5, 200)
        ...
        self.blocks_multiply_const_vxx_0_0 = blocks.multiply_const_cc(cell_gain0)
        ...
        self.connect((self.blocks_multiply_const_vxx_0_0, 0), (self.blocks_throttle2_0_0_0, 0))
        self.connect((self.blocks_multiply_const_vxx_0_0_0, 0), (self.blocks_throttle2_0_0_0_0, 0))
        self.connect((self.blocks_multiply_const_vxx_0_1, 0), (self.blocks_throttle2_0_0_1, 0))
        self.connect((self.blocks_throttle2_0_0, 0), (self.zeromq_rep_sink_0, 0))
        self.connect((self.blocks_throttle2_0_0_0, 0), (self.zeromq_rep_sink_0_0, 0))
        self.connect((self.blocks_throttle2_0_0_0_0, 0), (self.zeromq_rep_sink_0_0_0, 0))
        self.connect((self.blocks_throttle2_0_0_1, 0), (self.zeromq_rep_sink_0_1, 0))
        ...
        self.connect((self.zeromq_req_source_0_0_0, 0), (self.blocks_multiply_const_vxx_0_0_0, 0))
    ...
    def set_cell_gain0(self, cell_gain0):
        ...
        self.blocks_multiply_const_vxx_0_0.set_k(self.cell_gain0)
...
def main(top_block_cls=two_ue_two_gnb, options=None):
